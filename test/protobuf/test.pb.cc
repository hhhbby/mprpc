...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::User, gender_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "esponse\022\037\n\003res\030\001 \001(\0132\022.fixbug.ResultCode"
  "\022\017\n\007success\030\002 \001(\010\"\"\n\024GetFriendListReques"
  "t\022\n\n\002id\030\001 \001(\r\"^\n\004User\022\014\n\004name\030\001 \001(\014\022\013\n\003a"
  "ge\030\002 \001(\r\022 \n\006gender\030\003 \001(\0162\020.fixbug.User.S"
  "EX\"\031\n\003SEX\022\007\n\003MAN\020\000\022\t\n\005WOMAN\020\001\"[\n\025GetFrie"
  "ndListResponse\022\037\n\003res\030\001 \001(\0132\022.fixbug.Res"
  "ultCode\022!\n\013friend_list\030\002 \003(\0132\014.fixbug.Us"
  "er2\224\001\n\016UserServiceRpc\0224\n\005Login\022\024.fixbug."
  "LoginRequest\032\025.fixbug.LoginResponse\022L\n\rG"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  &descriptor_table_test_2eproto_initialized, descriptor_table_protodef_test_2eproto, "test.proto", 566,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          CHK_(ptr);
          _internal_set_gender(static_cast<::fixbug::User_SEX>(val));
        } else goto handle_unusual;
        continue;
      default: {
      handle_unusual:
